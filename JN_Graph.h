...
class JN_Graph {
  private:
    ...
    void eval_values(int* upper_val, int* middle_val, int* lower_val, float vals[], int only_act_val);
  ...
  public:
    JN_Graph ( int stored_vals, int stored_vals_first, int x_axes_start, int x_axes_length, int y_upper_axes_start, int y_lower_axes_start, int meas_point_radius);
